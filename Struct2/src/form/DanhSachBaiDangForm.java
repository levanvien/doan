...
public class DanhSachBaiDangForm extends ActionForm {
	/**
	 * 
	 */
	...
	public DanhSachBaiDangForm(int id_post, int id_account, String title_post, String content_post, String type_product,
